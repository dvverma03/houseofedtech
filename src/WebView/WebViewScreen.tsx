        ...
        <ThemedView style={styles.controlsContainer}>
          <ThemedView style={styles.buttonRow}>
            ...
            <ThemedView
              ...
              <ThemedText style={styles.buttonText}>Forward →</ThemedText>
            </ThemedView>

            <ThemedView
              style={[styles.button, styles.actionButton]}
              onTouchEnd={handleReload}>
              <ThemedText style={styles.buttonText}>Reload</ThemedText>
            </ThemedView>
          </ThemedView>
          ...
          <ThemedView style={styles.notificationButtons}>
            <ThemedView
              ...
              <ThemedText style={styles.buttonText}>Notify Action A (3s)</ThemedText>
            </ThemedView>

            <ThemedView
              style={[styles.button, styles.secondaryButton]}
              onTouchEnd={handleActionB}>
              <ThemedText style={styles.buttonText}>Notify Action B (5s)</ThemedText>
            </ThemedView>
          </ThemedView>
        </ThemedView>
      </ThemedView>
